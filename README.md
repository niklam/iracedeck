...
All packages share a single version number, driven by [release-it](https://github.com/release-it/release-it) plus one custom hook. Nothing is inferred from commit messages — you choose the version, and release-it asks before it commits, tags, pushes, or publishes anything.
