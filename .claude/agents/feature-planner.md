...
Use `packages/iracing-plugin-stream-deck` as the canonical reference for all patterns: plugin structure, action implementation, icon templates (Standard and Inverted label layouts), PI templates, tests, and keyboard shortcut actions.
