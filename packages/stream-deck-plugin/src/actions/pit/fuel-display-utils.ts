...
function generateFuelText(isFuelFillEnabled: boolean, fuelAmount: number | null): string {
  ...
  return `
    <text x="36" y="65" text-anchor="middle" dominant-baseline="central" fill="#ffffff" font-family="sans-serif" font-size="12" font-weight="bold">${escapeXml(displayText)}</text>`;
}
