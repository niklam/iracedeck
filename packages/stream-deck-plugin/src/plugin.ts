...
import { SessionInfo } from "./actions/session-info.js";
import { SetupAero } from "./actions/setup-aero.js";
import { SetupBrakes } from "./actions/setup-brakes.js";
import { SetupChassis } from "./actions/setup-chassis.js";
import { SetupEngine } from "./actions/setup-engine.js";
import { SetupFuel } from "./actions/setup-fuel.js";
import { SetupHybrid } from "./actions/setup-hybrid.js";
import { SetupTraction } from "./actions/setup-traction.js";
import { SplitsDeltaCycle } from "./actions/splits-delta-cycle.js";
import { TelemetryControl } from "./actions/telemetry-control.js";
import { TelemetryDisplay } from "./actions/telemetry-display.js";
...
streamDeck.actions.registerAction(new SessionInfo());
streamDeck.actions.registerAction(new SetupAero());
streamDeck.actions.registerAction(new SetupBrakes());
streamDeck.actions.registerAction(new SetupChassis());
streamDeck.actions.registerAction(new SetupEngine());
streamDeck.actions.registerAction(new SetupFuel());
streamDeck.actions.registerAction(new SetupHybrid());
streamDeck.actions.registerAction(new SetupTraction());
streamDeck.actions.registerAction(new SplitsDeltaCycle());
streamDeck.actions.registerAction(new TelemetryControl());
streamDeck.actions.registerAction(new TelemetryDisplay());
