...
- Any Stream Deck device: Stream Deck, Stream Deck Mini, Stream Deck XL, or Stream Deck+
...
Most iRaceDeck actions support the Stream Deck+ dial. When you place an action on a dial slot, rotating the dial typically cycles through options or adjusts values, while pressing the dial activates the primary action.

## Mirabox Ecosystem

The Mirabox ecosystem covers devices from brands including **Stream Dock**, **SOOMFON**, **VAPOURD**, **KILOGOGRAPH**, **HALCONTORNO**, **VSDinside**, and **Nouvolo**.
