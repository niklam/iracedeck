...
- **Enough fuel to finish** (`calloutEnabledFuelLapsLeftRaceCovered`) — the one-time *"We have enough fuel to finish the race!"* reassurance spoken in place of the first suppressed warning when the tank covers what's left of the race.
