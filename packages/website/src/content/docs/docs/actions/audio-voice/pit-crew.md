...
- **Black flag** (`calloutEnabledOpponentFlagBlack`) — a black flag on a car that matters to you, including the aggregate "several cars around us have penalty flags" call.
