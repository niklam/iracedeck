...
- **Checkered** — session-aware: practice, qualifying, and race finishes get distinct lines. Spoken as you take the flag at the start/finish line, not the moment the session ends — so on your final qualifying lap the call comes when you actually cross the line. (If you're in the pits or out of the car when the checkered flies, it's spoken right away.)
