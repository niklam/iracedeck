...
- **Enough fuel to finish** (`calloutEnabledFuelLapsLeftRaceCovered`) — the one-time *"We have enough fuel to finish the race!"* confirmation, spoken once the race is inside its last 10 laps and the tank covers what's left of it.
