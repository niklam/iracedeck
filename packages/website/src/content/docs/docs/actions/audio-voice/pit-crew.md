...
- **Enough fuel to finish** (`calloutEnabledFuelLapsLeftRaceCovered`) — the one-time *"We have enough fuel to finish the race. No need to box for fuel."* confirmation, spoken once the race is inside its last 10 laps and the tank covers what's left of it.
