...
The replay lands just **before** the car takes the line — so you see the crossing into the timed lap — and **plays** from there at 1×. The Play / Pause key shows PAUSE and pauses on its next press.
