...
- **Another pack already provides that voice** — two packs cannot both supply the same voice. The pack iRaceDeck keeps current claims its voice first; after that, the one that comes first alphabetically wins and the other is ignored. Rename or remove one of them.
