...
iRaceDeck provides **30 actions** with **288 controls** across 8 categories. See the [Actions Overview](/docs/actions/overview/) for a full breakdown, or jump to a category:
...
- [Cockpit & Interface](/docs/actions/cockpit/cockpit-misc/) — Wipers, FFB, delta splits, telemetry logging, UI toggles
