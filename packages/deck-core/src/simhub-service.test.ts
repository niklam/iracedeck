...
describe("SimHub Service", () => {
  beforeEach(() => {
    ...
    mockGetGlobalSettings.mockReturnValue({
      ...
      debugLogging: false,
      focusIRacingWindow: "never",
      mouseToSimAnchorX: "center" as const,
      mouseToSimAnchorY: "top" as const,
      mouseToSimOffsetX: 0,
      ...
      calloutEnabledLimiterOnTrack: true,
      ...
      calloutEnabledCautionFollow: true,
      calloutEnabledCautionPaceCarOut: true,
      calloutEnabledCautionFieldCaught: true,
      calloutEnabledCautionExtraLap: true,
      calloutEnabledCautionOneToGo: true,
      ...
      calloutEnabledGapTrend: true,
      calloutEnabledGapThreshold: true,
      gapAlertThresholdSeconds: 1,
      gapCalloutCooldownSeconds: 30,
      gapCalloutMinChangeSeconds: 1.5,
      ...
      calloutEnabledFlagDisqualify: true,
      calloutEnabledFlagFurled: true,
      calloutEnabledFlagFurledCleared: true,
      calloutEnabledFlagDqScoringInvalid: true,
      calloutEnabledFlagCrossed: true,
      calloutEnabledFlagOnePaceLapToGo: true,
      calloutEnabledFlagGreenHeld: true,
      calloutEnabledFlagTenToGo: true,
      calloutEnabledFlagFiveToGo: true,
      calloutEnabledFlagYellowWaving: true,
      calloutEnabledFlagCautionWaving: true,
      calloutEnabledStartLights: true,
      calloutEnabledStartCountdown: true,
      calloutEnabledRollingStartPaceCar: true,
      calloutEnabledPitOpenClosed: true,
      calloutEnabledOpponentPitLeader: true,
      calloutEnabledOpponentPitNearby: true,
      calloutEnabledOpponentFlagFurled: true,
      calloutEnabledOpponentFlagBlack: true,
      calloutEnabledOpponentFlagMeatball: true,
      calloutEnabledOpponentFlagDisqualify: true,
      calloutEnabledPitReadbackEntry: true,
      calloutEnabledPitReadbackExit: true,
      calloutEnabledTireWearReport: true,
      calloutEnabledPitServiceRequests: true,
      calloutEnabledPitServiceAutoFuel: true,
      ...
      calloutEnabledFuelLapsLeft10: false,
      calloutEnabledFuelLapsLeft9: false,
      calloutEnabledFuelLapsLeft8: false,
      calloutEnabledFuelLapsLeft7: false,
      calloutEnabledFuelLapsLeft6: false,
      calloutEnabledFuelLapsLeft5: true,
      calloutEnabledFuelLapsLeft4: false,
      calloutEnabledFuelLapsLeft3: true,
      calloutEnabledFuelLapsLeft2: true,
      calloutEnabledFuelLapsLeft1: true,
      calloutEnabledFuelLapsLeftBox: true,
      calloutEnabledFuelLapsLeftRaceCovered: true,
      calloutEnabledPitSpeedingCue: true,
      fuelCalloutMarginLaps: 0.3,
