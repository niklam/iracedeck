...
export const SCENARIO_SHORTCUTS: readonly ScenarioShortcut[] = [
  ...
  },
  {
    ...
    description: "Lap-over-lap gap ahead flipped to opening and held 2 laps.",
    event: "gap.trendChanged",
  ...
  },
  {
    ...
    description: "Lap-over-lap gap behind flipped to closing and held 2 laps.",
    event: "gap.trendChanged",
  ...
  },
  {
    ...
    description: "Lap-over-lap gap behind flipped to opening and held 2 laps.",
    event: "gap.trendChanged",
    data: { side: "behind", direction: "opening", gapSeconds: 2.8, previousGapSeconds: 2.0, carIdx: 5, lap: 8 },
  },
  {
