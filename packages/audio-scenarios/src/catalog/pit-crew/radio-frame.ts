 ...
 *
 * The pit-crew radio experience wraps every voice message with a
 ...
 * entry can compose the frame with `@pit-crew.radio-open` and
 * `@pit-crew.radio-close`, keeping each scenario's focus on its own
 * message content.
 *
