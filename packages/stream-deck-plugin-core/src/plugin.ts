...
import { TestAlpha } from "./actions/test-alpha.js";
import { TestBeta } from "./actions/test-beta.js";
import { TestGamma } from "./actions/test-gamma.js";
...
streamDeck.actions.registerAction(new TestAlpha());
streamDeck.actions.registerAction(new TestBeta());
streamDeck.actions.registerAction(new TestGamma());
