...
`scripts/claude-hooks/rules-bash.mjs`, `scripts/claude-hooks/pre-bash.mjs` (four context helpers), `scripts/claude-hooks/lib.mjs` (two readers), `scripts/claude-hooks/rules-bash.test.mjs`, `scripts/claude-hooks/lib.test.mjs`, `.claude/rules/specs-and-plans.md`, `.claude/rules/hooks.md`, `.claude/agents/feature-planner.md`.
