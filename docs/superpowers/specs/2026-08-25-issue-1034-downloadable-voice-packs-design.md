# Downloadable Race Engineer Voice Packs — Design

Issue: [#1034](https://github.com/niklam/iRaceDeck/issues/1034) - `feat(audio): distribute Race Engineer voices as downloadable packs`.
