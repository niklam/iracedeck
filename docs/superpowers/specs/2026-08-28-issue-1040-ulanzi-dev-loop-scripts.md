...
- The Mirabox scripts' **behaviour and messages are load-bearing** — `scripts/CLAUDE.md` and the website setup page quote their defaults, and the error text names the env var to set. Refactoring must leave Mirabox output identical.
