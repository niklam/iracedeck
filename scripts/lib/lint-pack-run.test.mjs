...
describe("runLintPack", () => {
  ...
  it("hands the linter the engine's own compile, bound, and the manifest's shared clips", async () => {
    ...
    // No managed voice id (#1144): another pack's voice of the same id is a different voice, not a claim.
    expect(calls[0]).not.toHaveProperty("managedVoiceIds");
  });
